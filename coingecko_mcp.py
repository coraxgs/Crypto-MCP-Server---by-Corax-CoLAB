...
"""
coingecko_mcp.py
CoinGecko MCP server for GAP Crypto MCP Server – Produced by Corax CoLAB - The Future of Edge AI & Blockchain
...
@mcp.tool()
def ping() -> str:
    return "coingecko_mcp alive — GAP Crypto MCP Server (Corax CoLAB - The Future of Edge AI & Blockchain)"
...
if __name__ == "__main__":
    print("Starting coingecko_mcp on http://127.0.0.1:7010/mcp — GAP Crypto MCP Server (Corax CoLAB - The Future of Edge AI & Blockchain)")
